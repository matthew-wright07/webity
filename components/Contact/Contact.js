...
export default function Contact(){
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center gap-4">
            <div className="flex flex-col justify-center w-full lg:w-3/4 border border-white rounded-lg p-10 gap-4">
                <h1 className="text-2xl font-bold text-center">Contact</h1>
                <div className="flex flex-col gap-2">
                    <label htmlFor="to">To</label>
                    <select name="to" id="to" className="border border-white rounded-lg p-3 hover:cursor-pointer">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input onChange={handleName} value={name} id="name" className="rounded-lg p-3 border border-white "/>
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="email">Email</label>
                    <input onChange={handleEmail} value={email} id="email" className="rounded-lg p-3 border border-white "/>
                </div>
                <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <textarea onChange={handleMessage} value={message} id="message" className="rounded-lg p-3 border border-white "/>
                </div>
