...
export default function Contact(){
    ...
    return (
        <div className="px-8 lg:px-32 py-12 flex flex-col justify-center gap-4">
            <div className="flex flex-col justify-center w-full border border-white rounded-lg p-10 gap-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input onChange={handleName} value={name} id="name" className="rounded-lg p-4 border border-white "/>
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="email">Email</label>
                    <input onChange={handleEmail} value={email} id="email" className="rounded-lg p-4 border border-white "/>
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="product">Product</label>
                    <select onChange={handleProduct} value={product} name="product" id="product" className="border border-white rounded-lg p-4 hover:cursor-pointer">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <textarea onChange={handleMessage} value={message} id="message" className="rounded-lg p-4 border border-white "/>
                </div>
